                ...
                <div class="col-12 col-sm-10 col-md-8 col-lg-6 col-xl-6">
                    <div class="bg-light rounded p-4 my-4 mx-3">
                        ...
                        <div class="form-floating mb-3">
                            <input type="text" class="form-control" name="mobile_number" placeholder="jhondoe">
                            <label for="floatingText">Mobile Number</label>
                        </div>
                        <div class="form-floating mb-3">
                            <form action="" method="post">
                                <a href="" class="btn btn-primary">GET OTP</a>
                            </form>
                        </div>
                        <div class="form-floating mb-3">
                        ...
                        <button type="submit" name="submit" class="btn btn-primary py-3 w-100 mb-4">Continue</button>
