                ...
                <div class="row g-4">
                    <div class="col-sm-12 col-xl-12">
                        <div class="contents">
                            ...
                            <li>
                                <p>
                                <strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Coem Shop.
                                </p>
                            </li>
                            <li>
                            ...
                            <li>
                                <strong>Website</strong> refers to Coem Shop, accessible from https://coem.in
                            </li>
                            <li>
