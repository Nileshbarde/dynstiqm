...
<head>
    <meta charset="utf-8">
    <title>H Dynasta - Category</title>
            ...
            <div class="container-fluid pt-4 px-4">
                <div class="row">
                    <div class="col-sm-12 col-xl-4">
                        <a href="category_view.php" class="btn btn-info text-white mb-3">View Category
                        </a>
                    </div>
                </div>
                <div class="row g-4">
                    <div class="col-sm-12 col-xl-6">
                        ...
                        <form id="categoriesForm" enctype="multipart/form-data">
                            ...
                            <div class="form-floating mb-3">
                                <input type="text" class="form-control" id="status" name="status" placeholder="Color Name">
                            ...
                            <button type="submit" class="btn btn-primary py-2 w-100 mb-3 mt-2">Add Category</button>
                        </form>
                        <div id="message"></div>
                        </div>
                    </div>
